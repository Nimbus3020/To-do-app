...
import org.example.todoapplication.model.dao.TodoDAO;
import org.example.todoapplication.model.dao.TodoDAOImp;
...
/**
 * This class acts as a page controller for the application, handling
 * all requests from the todo.
 */
@WebServlet("/")
